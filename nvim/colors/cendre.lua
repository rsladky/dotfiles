...
hi("@function", { fg = c.light })
hi("@function.builtin", { fg = c.light, bold = true })
hi("@function.call", { fg = c.light })
hi("@function.macro", { fg = c.dark })
hi("@function.method", { fg = c.light })
hi("@function.method.call", { fg = c.light })

hi("@constructor", { fg = c.mid })
hi("@operator", { fg = c.fg2 })
...
hi("@type.definition", { fg = c.mid })
hi("@type.qualifier", { fg = c.coral })

hi("@attribute", { fg = c.dark })
hi("@property", { fg = c.mid })

hi("@comment", { fg = c.fg3 })
hi("@comment.todo", { fg = c.bg, bg = c.light, bold = true })
